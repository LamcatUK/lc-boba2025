	...
	<div class="u-columns col2-set" id="customer_login">
		...
		<form class="woocommerce-form woocommerce-form-login login" method="post">
			...
			<p class="form-row">
				...
				<btn btn-primary type="submit" class="woocommerce-btn btn-primary btn btn-primary woocommerce-form-login__submit<?php echo esc_attr(wc_wp_theme_get_element_class_name('btn btn-primary') ? ' ' . wc_wp_theme_get_element_class_name('btn btn-primary') : ''); ?>" name="login" value="<?php esc_attr_e('Log in', 'woocommerce'); ?>"><?php esc_html_e('Log in', 'woocommerce'); ?></btn btn-primary>
			</p>
		...
		<div class="u-column2 col-2">
			...
			<form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action('woocommerce_register_form_tag'); ?>>
				...
				<p class="woocommerce-form-row form-row">
					...
					<btn btn-primary type="submit" class="woocommerce-Button woocommerce-btn btn-primary btn btn-primary<?php echo esc_attr(wc_wp_theme_get_element_class_name('btn btn-primary') ? ' ' . wc_wp_theme_get_element_class_name('btn btn-primary') : ''); ?> woocommerce-form-register__submit" name="register" value="<?php esc_attr_e('Register', 'woocommerce'); ?>"><?php esc_html_e('Register', 'woocommerce'); ?></btn btn-primary>
				</p>
