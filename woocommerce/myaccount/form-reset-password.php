...
<form method="post" class="woocommerce-ResetPassword lost_reset_password">
	...
	<p class="woocommerce-form-row form-row">
		...
		<btn btn-primary type="submit" class="woocommerce-Button btn btn-primary<?php echo esc_attr(wc_wp_theme_get_element_class_name('btn btn-primary') ? ' ' . wc_wp_theme_get_element_class_name('btn btn-primary') : ''); ?>" value="<?php esc_attr_e('Save', 'woocommerce'); ?>"><?php esc_html_e('Save', 'woocommerce'); ?></btn btn-primary>
	</p>
